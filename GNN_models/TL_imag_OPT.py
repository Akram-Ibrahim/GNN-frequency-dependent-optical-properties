...
#### Multi-Fidelity (Transfer Learning) AvgNorm GNN -- Initial Training on all OPT data
...
with open('./dataset/opt/opt_avg_data.json', 'r') as f:
    data = json.load(f)
...
# Concatenate df_train and df_left along the rows (axis=0)
df_train = pd.concat([df_train, df_left], axis=0)

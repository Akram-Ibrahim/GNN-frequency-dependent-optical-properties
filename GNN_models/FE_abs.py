...
with open('/home/common/akram/dielectric/paper/jarvis_data/parse/mbj/mbj_avg_data.json', 'r') as f:
    data = json.load(f)
dff_mbj = pd.DataFrame(data)


with open('/home/common/akram/dielectric/paper/jarvis_data/parse/opt/opt_avg_data.json', 'r') as f:
    data = json.load(f)
...
df_mbj['abs_normalized'] = df_mbj['abs_interp'].apply(normalize_target)
df_mbj['abs_norm'] = df_mbj['abs_interp'].apply(target_norm)

df_opt['abs_normalized'] = df_opt['abs_interp'].apply(normalize_target)
df_opt['abs_norm'] = df_opt['abs_interp'].apply(target_norm)
##################
#----------------#
...
pointwise_spectrum_shape = df_mbj['abs_interp'].iloc[0].shape[0]
